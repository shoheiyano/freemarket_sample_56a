...
CarrierWave.configure do |config|
  ...
  config.fog_credentials = {
    ...
    aws_access_key_id: Rails.application.credentials.aws[:access_key_id], #credentials.ymlに鍵の本体があります
    aws_secret_access_key: Rails.application.credentials.aws[:secret_access_key], #credentails.ymlに鍵の本体があります
    region: 'ap-northeast-1'
  }

  config.fog_directory  = 'merukari56a'
  config.asset_host = 'https://s3-ap-northeast-1.amazonaws.com/merukari56a'
end
end